...
class Encoder(tf.keras.layers.Layer):
    def __init__(self, input_vocab_size=4, num_layers=4, d_model=512, num_heads=8, dff=2048, maximum_position_encoding=10000, dropout=0.0, norm_layer=True, **kwargs):
...
class Decoder(tf.keras.layers.Layer):
    def __init__(self, target_vocab_size=4, num_layers=4, d_model=512, num_heads=8, dff=2048, maximum_position_encoding=10000, dropout=0.0, norm_layer=True, **kwargs):
...
# def get_model(features_n=777, num_layers_enc=2, num_layers_dec=2,num_dense=3,dense_n=256, d_model=128, dff=512, num_heads=8, dropout_rate=0.1, wp_d=4,bs=32, concat_emb=False, optimizer="adam",norm_layer=True,activation="tanh"):
